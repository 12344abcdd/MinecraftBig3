...
/**
 * Precompiled neoforge.formatting-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class NeoforgeFormattingConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NeoforgeFormattingConventions").asSubclass(BasicScript.class);
