...
/**
 * Precompiled neoforge.versioning script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class NeoforgeVersioningPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_NeoforgeVersioning").asSubclass(BasicScript.class);
